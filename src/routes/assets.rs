...
pub use mutations::{
    check_asset_mutation_access, convert_assets_import_mode, delete_assets_permanently,
    restore_assets, set_asset_folders, set_asset_tags, trash_assets, update_asset,
    update_asset_derived_files, update_assets_rating, update_assets_starred, update_assets_viewer,
};
