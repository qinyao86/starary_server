...
pub async fn list_activity(
    ...
    let items = sqlx::query_as::<_, ActivityLogRecord>(
        ...
        SELECT
            ...
            actor.avatar_key AS actor_avatar_key,
            a.action,
            a.target_type,
            a.target_id,
            COALESCE(
        ...
        LEFT JOIN users target_user ON a.target_type = 'user' AND target_user.id::text = a.target_id
        LEFT JOIN libraries target_library ON a.target_type = 'library' AND target_library.id = a.target_id
        LEFT JOIN storage_roots target_root ON a.target_type = 'storage_root' AND target_root.id::text = a.target_id
