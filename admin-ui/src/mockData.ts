...
export const libraryPermissions = [
  ...
  { category: "permissionCategoryAssets", action: "organizeAssetFolders", scope: "all", target: "permissionTargetAllAssets", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "organizeAssetTags", scope: "own", target: "permissionTargetOwnAssets", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "organizeAssetTags", scope: "all", target: "permissionTargetAllAssets", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "manageAssetThumbnails", scope: "own", target: "permissionTargetOwnAssets", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "manageAssetThumbnails", scope: "all", target: "permissionTargetAllAssets", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "manageImageSequences", scope: "own", target: "permissionTargetOwnAssets", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "manageImageSequences", scope: "all", target: "permissionTargetAllAssets", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "moveAssetsToTrash", scope: "own", target: "permissionTargetOwnAssets", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "moveAssetsToTrash", scope: "all", target: "permissionTargetAllAssets", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "restoreAssets", scope: "own", target: "permissionTargetOwnAssets", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "restoreAssets", scope: "all", target: "permissionTargetAllAssets", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "deleteAssetsPermanently", scope: "own", target: "permissionTargetOwnAssets", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "deleteAssetsPermanently", scope: "all", target: "permissionTargetAllAssets", manager: true, editor: false, viewer: false, verified: false },
  ...
  { category: "permissionCategoryTransfer", action: "copyAssetsAcrossLibraries", scope: "own", target: "permissionTargetOwnAssets", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryTransfer", action: "copyAssetsAcrossLibraries", scope: "all", target: "permissionTargetAllAssets", manager: true, editor: false, viewer: false, verified: false },
