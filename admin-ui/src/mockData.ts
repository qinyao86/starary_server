...
export const libraryPermissions = [
  ...
  { category: "permissionCategoryImportTasks", action: "viewOwnTasks", scope: "personal", manager: true, editor: true, viewer: true, verified: true },
  { category: "permissionCategoryImportTasks", action: "controlOwnTasks", scope: "personal", manager: true, editor: true, viewer: true, verified: true },
  ...
  ...scopedRows("permissionCategoryTrashDuplicates", "emptyTrash", "permissionTargetOwnAssets", "permissionTargetAllAssets", true),
  { category: "permissionCategoryTrashDuplicates", action: "viewDuplicateAssets", scope: "all", manager: true, editor: false, viewer: false, verified: true },
