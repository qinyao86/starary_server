...
export const libraryPermissions = [
  ...
  { category: "permissionCategoryAssets", action: "editAssetBasicInfo", scope: "own", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "editAssetBasicInfo", scope: "all", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "organizeAssetFolders", scope: "own", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "organizeAssetFolders", scope: "all", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "organizeAssetTags", scope: "own", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "organizeAssetTags", scope: "all", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "manageAssetThumbnails", scope: "own", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "manageAssetThumbnails", scope: "all", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "manageImageSequences", scope: "own", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "manageImageSequences", scope: "all", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "moveAssetsToTrash", scope: "own", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "moveAssetsToTrash", scope: "all", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "restoreAssets", scope: "own", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "restoreAssets", scope: "all", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "deleteAssetsPermanently", scope: "own", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "deleteAssetsPermanently", scope: "all", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryAssets", action: "mergeDuplicateAssets", scope: "all", manager: true, editor: false, viewer: false, verified: false },
  ...
  { category: "permissionCategoryStructure", action: "manageFolders", scope: "own", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryStructure", action: "manageFolders", scope: "all", manager: true, editor: false, viewer: false, verified: false },
  { category: "permissionCategoryStructure", action: "createTags", scope: "create", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryStructure", action: "manageTags", scope: "own", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryStructure", action: "manageTags", scope: "all", manager: true, editor: false, viewer: false, verified: false },
  ...
  { category: "permissionCategoryStructure", action: "manageTagGroups", scope: "own", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryStructure", action: "manageTagGroups", scope: "all", manager: true, editor: false, viewer: false, verified: false },
  ...
  { category: "permissionCategoryTransfer", action: "copyAssetsAcrossLibraries", scope: "own", manager: true, editor: true, viewer: false, verified: false },
  { category: "permissionCategoryTransfer", action: "copyAssetsAcrossLibraries", scope: "all", manager: true, editor: false, viewer: false, verified: false },
